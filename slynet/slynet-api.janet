...
(def create-context api/create-context)
(def context-start-server api/context-start-server)
(def context-stop-server api/context-stop-server)
(def close-context api/close-context)
(def context-status api/context-status)
